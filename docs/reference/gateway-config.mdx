...
# startup, and a set-but-invalid value reaching a sandbox (for example an
# unreadable or malformed auth file) is fatal to that sandbox's supervisor
# instead of silently falling back to direct or unauthenticated egress.
#
